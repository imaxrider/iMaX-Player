...
//  iMaX Player
//
//  Created by SmartTaxi on 2/24/2560 BE.
//  Copyright © 2560 Rachanon Kwampien. All rights reserved.
//

import UIKit

@IBDesignable class IMTextField: UIView,UITextFieldDelegate {
    ...
    private func loadNib() {
        let bundle = Bundle(for: IMTextField.classForCoder())
        bundle.loadNibNamed("IMTextField", owner: self, options: nil)
    }
